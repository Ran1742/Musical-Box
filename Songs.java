...
public class Songs extends javax.swing.JFrame{
    ...
    private void initComponents() {
        ...
        jLabel1.setText("                 Music Playlist");

        jButton2.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jButton2.setText("HINDI SONGS");
        ...
        jButton3.setText("ENGLISH SONGS");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        setVisible(false);
        new HindiSongList().setVisible(true);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        // TODO add your handling code here:
        setVisible(false);
        new EnglishSongList().setVisible(true);
